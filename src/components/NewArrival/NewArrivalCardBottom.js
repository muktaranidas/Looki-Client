...
const NewArrivalCardBottom = ({ newArrival }) => {
  const { name, image, price } = newArrival;
  return (
    <div className="max-w-xs rounded-md shadow-md bg-white text-black-600">
      <img
        src={image}
        alt=""
...
export default NewArrivalCardBottom;
